...
os.system("nmap -sP "+ip_addr+" -oG - | awk '/Up$/{print $2}' > /home/cryptonic/Nesseus_auto/a.txt")
uname='cryptonic007'
pass1='nessus@123'
driver = webdriver.Chrome(executable_path="/home/cryptonic/Nesseus_auto/chromedriver")
driver.get("https://marvel:8834/")
...
pop_p.click()
'''
back_sc=wait.until(ec.visibility_of_element_located((By.XPATH,'/html/body/section[3]/section[1]/h1/a')))
back_sc.click()
sleep(4)
dele=driver.find_element_by_xpath('/html/body/section[3]/section[3]/section/div[2]/table/tbody/tr/td[9]/i')
'''